...
Generated from the production dependencies in `package-lock.json` for Factory 0.1.0. Re-run `npm run notices` after changing the dependency lock and review the resulting license text. Development-only tooling is excluded from the installed package notice list.
...
| `@openai/codex-linux-arm64` | 0.156.0-linux-arm64 | Apache-2.0 |
| `@openai/codex-linux-x64` | 0.156.0-linux-x64 | Apache-2.0 |
