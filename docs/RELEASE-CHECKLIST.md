...
This checklist tracks issue [#25](https://github.com/clockgrove/factory-rebuild/issues/25). Issues #19–#24 and #28 have merged. Checking a file into the repository does not satisfy the installed-artifact or live Objective gates.
...
| CHANGELOG                                      | `0.1.0` changes and release date listed                                                                               | Record exact artifact identity and acceptance evidence in BUILD-STATUS                                             |
...
1. Confirm accepted #19–#24 and #28 behavior in README, skills, and package tests; obtain review of this release candidate against the final CLI.
