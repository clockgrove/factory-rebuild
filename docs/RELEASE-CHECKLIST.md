...
The first release passed [#25](https://github.com/clockgrove/factory-rebuild/issues/25). This checklist now tracks the new immutable artifact required by [#44](https://github.com/clockgrove/factory-rebuild/issues/44) before the Clockgrove pilot. Checking a file into the repository does not satisfy the installed-artifact or live Objective gates.
...
| CHANGELOG                                      | `0.1.3` changes and release date listed                                                                               | Record exact artifact identity and acceptance evidence in BUILD-STATUS                                             |
...
1. Confirm accepted #19–#24, #28, and #44 behavior in README, skills, and package tests; obtain review of this release candidate against the final CLI.
...
5. Close #44 only after this evidence is recorded for the new artifact. Run the separate private adopter smoke in #26 with that same published artifact before claiming trunk acceptance. Do not retag `v0.1.0`.
