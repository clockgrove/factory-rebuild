...
| Installed use skills                           | `director` and `setup` packaged                                                                                       | Exercise planning, result decisions, media selection, and status with the installed CLI in a fresh target          |
| CLI                                            | Existing commands documented                                                                                          | Recheck merged plan/decide/run/decide-result commands against final CLI                                            |
